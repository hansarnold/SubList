...
2. [Reporting, Presets, and Symbols Refactor Plan](./reporting-presets-refactor-plan.md) — Approved cross-cutting behavior, implementation sequence, and the maintainer data cutover.
...
11. [Implementation Readiness Checklist](./pre-implementation-checklist.md) — Completed local gates and remaining hosted-deployment inputs.
...
- `reporting-presets-refactor-plan.md` owns the cross-document implementation sequence, approved preset and icon catalogs, and one-time maintainer cutover; focused documents still own their final contracts.
