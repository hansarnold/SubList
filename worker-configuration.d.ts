/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.example.jsonc --strict-vars=false` (hash: 9984ad152f798864ef580295655e351d)
...
interface __BaseEnv_Env {
	...
	TEAM_DOMAIN: string;
	POLICY_AUD: string;
	EMAIL_REMINDER_MODE: string;
	EMAIL_REMINDER_FROM: string;
	EMAIL_REMINDER_PROVIDER_CONFIG_REVISION: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "PUBLIC_ORIGIN" | "TEAM_DOMAIN" | "POLICY_AUD" | "EMAIL_REMINDER_MODE" | "EMAIL_REMINDER_FROM" | "EMAIL_REMINDER_PROVIDER_CONFIG_REVISION">> {}
}
